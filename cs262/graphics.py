...
#
# Fake Graphics Library
#
# This allows students with minimal knowledge to produce pretty pictures of
# HTML webpages.
#
# Students do not (necessarily) see the source to this module. Instead, it
# resides on the server and they make calls to it.
import sys
import subprocess
import os
...
""")
    ...
    #subprocess.call(cmd, shell=True)
    #output_image('Output', 'png', open(output_latex_filename + '.png').read())
