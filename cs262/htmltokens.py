...
# would write the JavaScript lexer as an assignment.
#
# The biggest tricky bit here is pulling out embedded JavaScript text
# as a single token. We'll process JavaScript text in a later step. 
