...
def p_exp_alteration(p):
    """exp : exp PIPE exp"""
    p[0] = ('alteration', p[1], p[3])


def p_group(p):
    """exp : LPAREN re RPAREN"""
    p[0] = ('group', p[2])
...
# start_state = 1
#
# test("a(b*)c", edges1, accepting_state, start_state,
...
# start_state = 1
#
# test("((ab)|(cd))*", edges1, accepting_state, start_state,
#      ["", "ab", "cd", "cddd", "c", "", "ad", "abcd", "abbbbbc", "ac"])
