...
def optimize(ast):
    def contains_var(exp, _var):
        if exp[0] == 'binop':
            return contains_var(exp[1], _var) or contains_var(exp[3], _var)
    ...
    replaceable = {}
    optimized = []
    for (_, var, exp) in ast:
        if exp in replaceable:
            optimized += [('assign', var, replaceable[exp])]
        else:
            optimized += [('assign', var, exp)]
        replaceable[exp] = ('identifier', var)
        replaceable = {exp: v2 for (exp, v2) in replaceable.iteritems() if not contains_var(exp, var)}
    return optimized
...
example1 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
            ("assign", "y", ("number", 2)),
            ("assign", "z", ("binop", ("identifier", "a"), "+", ("identifier", "b")))]

answer1 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
           ("assign", "y", ("number", 2)),
           ("assign", "z", ("identifier", "x"))]

print (optimize(example1)) == answer1

example2 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
            ("assign", "a", ("number", 2)),
            ("assign", "z", ("binop", ("identifier", "a"), "+", ("identifier", "b")))]

print (optimize(example2)) == example2

example3 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
            ("assign", "y", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
            ("assign", "x", ("number", 2)),
            ("assign", "z", ("binop", ("identifier", "a"), "+", ("identifier", "b")))]
answer3 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
...
example4 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
...
answer4 = [("assign", "x", ("binop", ("identifier", "a"), "+", ("identifier", "b"))),
           ("assign", "y", ("binop", ("identifier", "b"), "+", ("identifier", "c"))),
           ("assign", "z", ("binop", ("identifier", "c"), "+", ("identifier", "d"))),
