...
# precedence binary operators first, and then continue in order of
...
jstree3 = ('binop', ('binop', ('number', 1.0), '+', ('binop', ('number', 2.0), '*', ('number', 3.0))), '-', (
    'binop', ('binop', ('number', 4.0), '/', ('number', 5.0)), '*', ('binop', ('number', 6.0), '+', ('number', 2.0))))
print test_parser(jstext3) == jstree3

# String and boolean constants, comparisons.
jstext4 = ' "hello" == "goodbye" || true && false '
jstree4 = ('binop', ('binop', ('string', 'hello'), '==', ('string', 'goodbye')), '||',
           ('binop', ('true', 'true'), '&&', ('false', 'false')))
...
jstree6 = ('call', 'apply',
           [('number', 1.0), ('binop', ('number', 2.0), '+', ('call', 'eval', [('identifier', 'recursion')])),
            ('call', 'sqrt', [('number', 2.0)])])
