...
# Students are given a formal grammar and precedence chart to match.
# Students are also given a particular AST format to output, which is just
# tuples where the first element is a fixed type tag:
# ("assign", ("identifier","x"), ("number",2.0))
#
# Tricky Bits:
#       Understanding our AST format.
#       Declaring precedence and associativity.
#       Handling semicolon TERMINATED statements but comma SEPARATED args.
